...
const Dashboard = () => {
  ...
  const hapus = async (id) => {
    try {
      const response = await axios.delete(`http://localhost:5000/karyawan/${id}`);
          ...
          <div className="flex gap-5 justify-between">
            ...
            <div>
              ...
              <div className="h-[200px] overflow-y-scroll p-2 gap-5 flex-col flex">
                {task.map((item, index) => (
                  <TaskCard project={item.nama_tugas} key={index} />
                ))}
              </div>
            </div>
            ...
            <div className="w-[350px]">
              ...
              <div className="flex justify-between items-center border-2 rounded-lg p-1 border-black">
